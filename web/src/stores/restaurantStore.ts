...
function catalogToStore(catalog: CatalogResponse) {
  ...
  const data: RestaurantData = {
    ...
    categories,
    promotion: undefined,
    features: r.features ? { aiChat: r.features.aiChat, aiVoice: r.features.aiVoice, analytics: r.features.analytics, ordering: r.features.ordering, primaryLocale: r.features.primaryLocale, enabledLocales: r.features.enabledLocales, disabledLocales: r.features.disabledLocales, customLocales: r.features.customLocales } : undefined,
  };
